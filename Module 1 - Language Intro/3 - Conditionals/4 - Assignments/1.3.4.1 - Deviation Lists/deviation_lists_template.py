...
### YOUR CODE HERE
# Calculate standard deviation for both lists
std_A = np.std(random_list_A)
std_B = np.std(random_list_B)

# Assign the list with the larger standard deviation
if std_A > std_B:
...
longest_list_is = longest_list_is = random_list_A if np.std(random_list_A) > np.std(random_list_B) else random_list_B
